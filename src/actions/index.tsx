import { AppActions, FETCH_USERS, LOADING, LOADED, FETCH_USER } from '../types/action';
import githubAPI from '../apis/githubAPI';
import { AppState } from '../store/configureStore';
import { Dispatch } from 'redux';
import { IUser, User } from '../types/users';

export const fetchUsers = (searchCity: string, searchSkill: string, currentPage: number ) => 
...
export const fetchUser = (id: number) => async (dispatch: Dispatch<AppActions>) => {
    dispatch({type: LOADING});
